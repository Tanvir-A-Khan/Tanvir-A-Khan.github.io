...
const FOCUS_AREAS = ['React', 'TypeScript', 'Editor', 'Calendar', 'Node.js', 'Activity Logger']
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-[clamp(24px,4vw,56px)]">
        <div>
          ...
          <h2 id="now-h" className="mb-3.5 text-[clamp(26px,3vw,34px)] leading-[1.15] font-medium tracking-[-0.025em]">
            Full-stack engineering, at enterprise scale
          </h2>
          <p className="max-w-[40ch] text-[15.5px] leading-[1.7] text-ink3">
            Junior Software Engineer at IBM since August 2026, working full-stack on LambdaX — an
            enterprise agreement and contract management platform. Before that, nearly two years on
            the same product and the same role at Cognitus, acquired by IBM.
          </p>
        </div>
        <div className={`${glass('panel')} rounded-xl p-[clamp(20px,2.6vw,28px)]`}>
          ...
          <p className="mb-[22px] text-[14.5px] leading-[1.7] text-ink3">
            Full-stack development on LambdaX in the lax-web-portal codebase — React and TypeScript
            on the frontend, Node.js on the backend — shipping reviewed functionality and resolving
            production defects with a distributed team across US and European timezones.
          </p>
