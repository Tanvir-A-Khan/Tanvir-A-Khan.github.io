...
export function glass(bg: 'card' | 'panel' = 'card'): string {
  return `bg-${bg} bg-[image:linear-gradient(152deg,var(--sheen),transparent_58%)] backdrop-blur-[20px] backdrop-saturate-150 shadow-[var(--shadow),inset_0_1px_0_var(--glassHi)]`
}
